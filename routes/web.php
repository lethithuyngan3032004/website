...
Route::prefix('admin')->group(function () {
    ...
    Route::prefix('product')->group(function () {
        ...
        Route::get('status/{id}', [ProductController::class, 'status'])->name('admin.product.status');        Route::get("delete/{id}", [ProductController::class, "delete"])->name("admin.product.delete"); // Sử dụng DELETE cho xóa tạm
