...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="{{ asset('dist/img/thuyngan.jpg') }}" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="#" class="d-block">LeThiThuyNgan</a>
        </div>
      </div>
      <nav class="mt-2">
  ...
  <footer class="main-footer">
    ...
    <strong>Sửa bởi: Thúy Ngân</strong> All rights reserved.
  </footer>
